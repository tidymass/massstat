...
massstat_attach <- function() {
  ...
  #     right = paste0("massstat ", package_version("massstat"))
  #   ),
  #   startup = TRUE
  # )
...
msg <- function(..., startup = FALSE) {
  if (startup) {
    if (!isTRUE(getOption("massstat.quiet"))) {
...
#' List all packages in the massstat
#'
